<div align="center"><h2>
<img src="https://raw.githubusercontent.com/IAAR-Shanghai/xFinder/main/assets/xfinder_logo.png" alt="xFinder_logo" width=23px>xFinder: Large Language Models as Automated Evaluators for Reliable Evaluation</h2></div>

<p align="center">
    <!-- OpenReview badge with a more vibrant academic blue -->
    <a href="https://openreview.net/forum?id=7UqQJUKaLM" target="_blank">
        <img src="https://img.shields.io/badge/OpenReview-Paper-2C7BFF?style=flat-square&logo=openreview&logoColor=white" alt="OpenReview">
    </a>
...
## :loudspeaker: News
- **[2025/01]** Our work has been accepted to [ICLR 2025](https://openreview.net/forum?id=7UqQJUKaLM)! 🎉🎉🎉
